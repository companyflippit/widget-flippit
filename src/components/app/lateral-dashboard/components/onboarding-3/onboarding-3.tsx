...
@Component({
  tag: 'ion-onboarding-3',
  styleUrl: 'onboarding-3.scss'
})
    ...
    return (
      <div class="onboarding-container">
        <div class="svg-container">
          <svg onClick={() => this.navigate.emit('onboarding2')} class="arrowLeft" width="28px" height="23px" viewBox="0 0 28 23">
          ...
          <img src="https://res.cloudinary.com/dqoospd3u/image/upload/v1547562722/onboarding3.png"/>
        </div>
        <h2 class="title">Prueba con 10 Flips Gratis</h2>
        <h3 class="subtitle">Colabora y da Flips a quién consideres con tus 10 de prueba, sólo debes registrarte sin más.</h3>
