...
@Component({
  tag: 'ion-onboarding-2',
  styleUrl: 'onboarding-2.scss'
})
    ...
    return (
      <div class="onboarding-container">
        <div class="svg-container">
          <svg onClick={() => this.navigate.emit('onboarding')} class="arrowLeft" width="28px" height="23px" viewBox="0 0 28 23">
            <g id="02_User" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" opacity="0.396897">
              <g id="Onboarding-0101" transform="translate(-911.000000, -345.000000)" fill="#FFFFFF">
                <g id="icon/arrow/white" transform="translate(925.000000, 357.000000) rotate(-360.000000) translate(-925.000000, -357.000000) translate(911.000000, 345.000000)">
          ...
          <img src="https://res.cloudinary.com/dqoospd3u/image/upload/v1547562722/onboarding2.png"/>
          <svg onClick={() => this.navigate.emit('onboarding3')} class="arrowRight" width="28px" height="23px" viewBox="0 0 28 23">
            <g id="02_User" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" opacity="0.396897">
        ...
        <h2 class="title">¿A quién no le gusta premiar?</h2>
        <h3 class="subtitle">Por eso nace Flippit, donde premias con micropagos de 10 céntimos llamados flips, a los autores que crees que lo merecen y les apoyas para que sigan creando más.</h3>
